function [mean_error_all, conf_error_all, sigma_folds] = cross_Bay_dat(X, Y, M, R, maxIte)
...
[W_mean, W_cov, norms] = CP_ALS_Bay_weights(X, Y, M, R, maxIte, sigma);
[pred, var_CI, var_PI] = CP_ALS_Bay_predict(XTest, W_mean, W_cov, norms, M);
