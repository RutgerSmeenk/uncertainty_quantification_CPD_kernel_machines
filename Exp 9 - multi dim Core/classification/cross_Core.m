function [mean_error_all, conf_error_all, sigma_folds, noise_folds] = cross_Core(X, Y, M, R, maxIte, sto_core, lambda_delta)
...
[pred, var_CI, var_PI] = CP_ALS_Core_predict(XTest, W, norms, M, sigma, sto_core, Y, X, sigmae);
%pred = sign(pred) ;
