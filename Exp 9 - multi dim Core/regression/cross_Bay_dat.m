function [mean_error_all, conf_error_all, sigma_folds, lambda_folds] = cross_Bay_dat(X, Y, M, R, maxIte, sto_core)
...
CI_lower = pred - (sqrt(var_PI)) ;
CI_upper = pred + (sqrt(var_PI)) ;
